...
```bash
git add .gitignore env/.env.example pyproject.toml uv.lock 2024-CVPR-RDE/utils/options.py 2024-CVPR-RDE/utils/efficiency.py 2024-CVPR-RDE/utils/wandb_tracking.py tests
